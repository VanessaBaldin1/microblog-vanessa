...
if (isset($_POST['entrar'])) {
    ...
    $senha = $_POST['senha']; //não precisa sanitizar, pois será codificado/verificado
    ...
    try {
        ...
        //Se não existir usuário com o e-mail informado, mantem na pagina login e apresenta mensagem
        ...
        if($usuario && password_verify($senha, $usuario['senha'])){
            ...
            //Estando tudo ok(usuario e senha), passamos para o metodo login os dados da pessoa que esta logando
