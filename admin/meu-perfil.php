...
//Necessário chamar o exigirLogin para que esta pagina tenha acesso aos dados da sessão em andamento e do usuario logado.
ControleDeAcesso::exigirLogin();

$usuarioServico = new UsuarioServico();

//BUSCANDO OS DADOS DO USUÁRIO LOGADO MA SESSÃO A PARTIR DO ID DELE
...
if (isset($_POST["atualizar"])) {
	try {
		...
		//Avaliando a senha se o campo de senha estiver vazio, então vamos manter a mesma senha já existente no banco. Caso contrário, vamos repassar a senha digitada para a verificação
